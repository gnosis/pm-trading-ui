    ...
    <div className={cx('registerWallet')}>
      ...
      <div className={cx('registerContainer')}>
        ...
        <p className={cx('annotation')}>
          Please register your wallet address, where we can send you {collateralTokenSymbol} tokens,
          and subsequently your {rewardTokenSymbol} reward. Read our terms of service for more
          information
        </p>
