...
const { rewardToken, claimReward } = getFeatureConfig('rewards')
...
const mapDispatchToProps = dispatch => ({
  ...
  claimUserRewards: rewardValue => dispatch(claimUserRewards(rewardToken.address, claimReward.claimUntil, rewardValue)),
})
