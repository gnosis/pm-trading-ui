  ...
  results: [
    {
      ...
      event: {
        ...
        oracle: {
          ...
          eventDescription: {
            ...
            resolutionDate: '2018-12-30T00:00:00',
            decimals: 0,
            unit: '%',
          },
          type: 'CENTRALIZED',
      ...
      netOutcomeTokensSold: ['15211146333519251', '0'],
      stage: 1,
      tradingVolume: '9523809523809680',
      withdrawnFees: '0',
      collectedFees: '0',
      marginalPrices: ['0.7416', '0.2584'],
    },
    {
      contract: {
      ...
      event: {
        ...
        oracle: {
          ...
          eventDescription: {
            ...
            resolutionDate: '2018-09-03T12:00:00',
            decimals: 0,
            unit: 'Txs',
          },
          type: 'CENTRALIZED',
      ...
      netOutcomeTokensSold: ['0', '1391159866011082687'],
      stage: 1,
      tradingVolume: '857142857142872776',
      withdrawnFees: '0',
      collectedFees: '0',
      marginalPrices: ['0.2760', '0.7240'],
    },
    {
      contract: {
      ...
      event: {
        ...
        oracle: {
          ...
          owner: '0x9eab578556de5782445ec036f25a41902ba19eeb',
          eventDescription: {
            outcomes: ['<20 GWei', '20 GWei', '>20 GWei'],
            ...
            resolutionDate: '2018-09-01T12:00:00',
      ...
      fee: 0,
      funding: '1000000000000000000',
      netOutcomeTokensSold: ['0', '375216952973444123', '566120592814650422'],
      stage: 1,
      tradingVolume: '342952380952380954',
      withdrawnFees: '0',
      collectedFees: '0',
      marginalPrices: ['0.2287', '0.3454', '0.4259'],
    },
  ],
}
