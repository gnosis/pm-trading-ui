...
import {
  ScalarMarketRecord, CategoricalMarketRecord, BoundsRecord, OutcomeRecord,
} from 'store/models'
...
export class MarketFactory {
  static aKittiesMarket = aMarket()
    ...
    .withTitle(
      'How much will Cryptokitties transactions make up of the entire Ethereum network transactions by December 29th, in the last 1500 blocks?',
    )
    .withDescription(
      'How much of the total Ethereum transactions in the last 1500 blocks will be made by CryptoKitties game actions in the Ethereum network? The winning outcome will be calculated according to the sum of interactions with the smart contract address: 0x06012c8cf97bead5deae237070f9587f8e7a266d (CryptoKitties) and the address: 0xb1690c08e213a35ed9bab7b318de14420fb57d8c (CryptoKitties Auction) which make up for all the interactions made with CryptoKitties contracts. Source: https://ethgasstation.info/gasguzzlers.php',
    )
    ...
    .withOutcomes(
      new OutcomeRecord({
        name: 'SHORT',
        index: 0,
        marginalPrice: '0.7416',
        outcomeTokensSold: '15211146333519251',
      }),
      new OutcomeRecord({
        name: 'LONG',
        index: 1,
        marginalPrice: '0.2584',
        outcomeTokensSold: '0',
      }),
    )
    .withOutcomeTokensSold('15211146333519251', '0')
    .get()
  ...
  static aEthereumMarket = aMarket()
    ...
    .withDescription(
      'You can check the progress and number of Ethereum transactions here: https://etherscan.io/chart/tx',
    )
    ...
    .withOutcomeTokensSold('0', '1391159866011082687')
    .withOutcomes(
      new OutcomeRecord({
        name: 'SHORT',
        index: 0,
        marginalPrice: '0.2760',
        outcomeTokensSold: '0',
      }),
      new OutcomeRecord({
        name: 'LONG',
        index: 1,
        marginalPrice: '0.7240',
        outcomeTokensSold: '1391159866011082687',
      }),
    )
    .get()
  ...
  static aGasPriceMarket = aMarket()
    ...
    .withOutcomes(
      new OutcomeRecord({
        name: '<20 GWei',
        index: 0,
        marginalPrice: '0.2287',
        outcomeTokensSold: '0',
      }),
      new OutcomeRecord({
        name: '20 GWei',
        index: 1,
        marginalPrice: '0.3454',
        outcomeTokensSold: '375216952973444123',
      }),
      new OutcomeRecord({
        name: '>20 GWei',
        index: 2,
        marginalPrice: '0.4259',
        outcomeTokensSold: '566120592814650422',
      }),
    )
    .withOutcomeTokensSold('0', '375216952973444123', '566120592814650422')
    .get()
}
