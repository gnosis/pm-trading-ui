...
if ! $PASS; then
  echo -e "\033[0;31mCOMMIT SUCCEEDED BUT PLEASE FIX ESLINT ERRORS:\033[0m Your commit contains files that should pass ESLint but do not. Please fix the ESLint errors in a new commit.\n"
else
